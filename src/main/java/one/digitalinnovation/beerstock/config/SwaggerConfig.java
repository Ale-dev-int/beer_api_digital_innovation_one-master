...
public class SwaggerConfig {
    ...
    private static final String CONTACT_NAME = "Alexandre Araújo";
    private static final String CONTACT_GITHUB = "https://github.com/Ale-dev-int";
    private static final String CONTACT_EMAIL = "alexandrearaujo_udi@hotmail.com";
